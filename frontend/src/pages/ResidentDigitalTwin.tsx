        ...
        <div style={{ display: 'grid', gap: 20 }}>
          ...
          <div className="card" style={{ padding: 20, background: 'linear-gradient(135deg, #1e293b, #334155)' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
              ...
              <div style={{ flex: 1 }}>
                <h2 style={{ margin: 0, color: '#fff', fontSize: 20 }}>{twin.personal.name}</h2>
                <div style={{ display: 'flex', gap: 16, marginTop: 6, flexWrap: 'wrap' }}>
                  <span style={{ fontSize: 12, color: '#94a3b8' }}>Room {twin.personal.room_number}</span>
                  ...
                  <span style={{ padding: '2px 8px', borderRadius: 10, background: '#6366f120', color: '#a5b4fc', fontSize: 11, fontWeight: 600 }}>{twin.personal.care_type}</span>
                </div>
              </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 16 }}>
            ...
            <div className="card" style={{ padding: 18 }}>
              ...
              <div style={{ display: 'grid', gap: 8, fontSize: 13 }}>
                <div><strong>Risk Level:</strong> <span style={{ color: twin.medical.risk_level === 'high' ? '#dc2626' : twin.medical.risk_level === 'medium' ? '#d97706' : '#16a34a' }}>{twin.medical.risk_level}</span></div>
                ...
                {twin.medical.medications?.length > 0 && (
                  <div>
                    <strong>Active Medications ({twin.medical.medications.length}):</strong>
